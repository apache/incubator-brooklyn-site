...
# $ JEKYLL=2.1.0 ./deploy-site.sh [username] [password]
...
jekyll _${JEKYLL_BUILD_VERSION}_ build


if [ ! -d "site-content" ]; then
  svn co https://svn.apache.org/repos/asf/incubator/brooklyn/site site-content
else
  svn up site-content
fi
